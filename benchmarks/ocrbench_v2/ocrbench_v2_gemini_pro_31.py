...
Usage:
    ...
    uv run -m benchmarks.ocrbench_v2.ocrbench_v2_gemini_pro_31 --predict-only
    uv run -m benchmarks.ocrbench_v2.ocrbench_v2_gemini_pro_31 --evaluate-only
"""
...
PRED_OUTPUT = RESULTS_DIR / "ocrbench_v2_gemini_pro_31_predictions.json"
EVAL_OUTPUT = RESULTS_DIR / "ocrbench_v2_gemini_pro_31_scored.json"
...
def run_evaluation():
    ...
    metrics_path = RESULTS_DIR / "ocrbench_v2_gemini_pro_31_metrics.json"
